...
<img width= 200px height = 200px class="rounded float-start pe-4" src="../img/ui-framwork/pure_html_css.JPG">
...
<img width= 200px height = 200px class="rounded float-start pe-4" src="../img/ui-framwork/bootstrap.JPG">
